...
![@Schema](../../images/java-start/java_class_file.png)<br>
...
<a href="/language/java-start-01" class="pagination&#45;&#45;pager" title="{{ page.previous.title | markdownify | strip_html }}"> 👈 Java start(1)</a>
